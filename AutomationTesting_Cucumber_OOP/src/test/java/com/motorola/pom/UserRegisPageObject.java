...
import static com.motorola.utils.RegistrationConstants.REGIS_ERROR_MSG_XPATH;
...
public class UserRegisPageObject extends DriverInitialization {
    ...
    @FindBy(xpath = RegistrationConstants.F_GENDER_XPATH)
    WebElement fGender;
    ...
    @FindBy(xpath = RegistrationConstants.ERROR_MESSAGE_XPATH)
    WebElement errorMsg;
    ...
    @FindBy(xpath = REGIS_ERROR_MSG_XPATH)
...
//            selectCountry.selectByValue(userDetailsBean.getCountry());
    ...
    public void fillRegistrationWithInvalidData(String fN, String lN,String mobileNo, String zipcode ,String addr, String cityName){
            explicitWaitSendKeys(firstName, 5);
